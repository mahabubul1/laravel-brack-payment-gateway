	...
	<BODY class="bg">
		...
		<TABLE align=center border=1 bordercolor=black>
			<tr>
				...
				}else if(isset($_GET["ErrorText"]) || isset($_POST["ErrorText"])) {?>
				<TR>
									<TD>
										Transaction Status
									</TD>
					...
					<TR>
						<TD> ErrorText </TD>
						<TD> &nbsp;&nbsp;<?php echo trim(isset($_GET["ErrorText"]) ? $_GET["ErrorText"] : isset($_POST["ErrorText"]) ? $_POST["ErrorText"] : "");?></TD>
					</TR>
					<?php } else { ?>
					<TR>
					...
					<TR>
								...
								<TR>
									...
									<TD>
										&nbsp;&nbsp;<?php echo $myObj->getCardNumber();?></TD>
								</TR>
								<TR>
									<TD>
										Issuer Response Code
